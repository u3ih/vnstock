...
class Trading:
    ...
    def price_board(
        ...
        drop_columns = [
            ...
            ("bid_ask", "symbol"),
            ("bid_ask", "session"),
            ("bid_ask", "received_time"),
            ("bid_ask", "message_type"),
            ("bid_ask", "time"),
            ("bid_ask", "bid_prices"),
            ("bid_ask", "ask_prices"),
            ("listing", "code"),
            ("listing", "exercise_price"),
            ("listing", "exercise_ratio"),
            ("listing", "maturity_date"),
            ("listing", "underlying_symbol"),
            ("listing", "issuer_name"),
            ("listing", "received_time"),
            ("listing", "message_type"),
            ("listing", "en_organ_name"),
            ("listing", "en_organ_short_name"),
            ("listing", "organ_short_name"),
            ("listing", "ticker"),
            ("match", "code"),
            ("match", "symbol"),
            ("match", "received_time"),
